...
Please note that it will completely override this actions original [deploy.php](https://github.com/rtCamp/action-deploy-wordpress/blob/master/deploy.php). So if you need some portion of original file, you need to copy that to your own `deploy.php`.
